...
st.sidebar.image('https://en.wikipedia.org/wiki/Olympic_symbols#/media/File:Olympic_rings_without_rims.svg')
...
if user_menu== 'Country-wise Analysis':
    ...
    top10_df= helper.most_sucessful_in_country(df, selected_country)
    st.table(top10_df)
